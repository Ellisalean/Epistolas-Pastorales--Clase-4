            ...
            <div className="flex flex-col lg:flex-row gap-10 items-stretch h-full">
               ...
               <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {slide.interaction?.revealItems?.map((item, i) => (
                    <div key={i} className="flex items-center gap-5 p-6 bg-white/5 rounded-[2.5rem] border border-white/5 transition-all hover:bg-white/10 hover:border-red-600/40 group text-left">
